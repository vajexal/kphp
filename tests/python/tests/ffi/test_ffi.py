...
class TestFFI(KphpCompilerAutoTestCase):
    ...
    def ffi_build_and_compare_with_php(self, php_script_path, shared_libs=[]):
        os.environ['LD_LIBRARY_PATH'] = self.test_dir
        ...
        for lib in shared_libs:
            ...
            i += 1
        kphp_default_ldflags = '-L${KPHP_PATH}/objs/flex -ggdb'
        ...
        self.assertTrue(once_runner.compile_with_kphp({
            'KPHP_EXTRA_LDFLAGS': '-ldl ' + kphp_default_ldflags,
        }))
    ...
    def test_vararg(self):
        self.ffi_build_and_compare_with_php('php/vararg.php', shared_libs=['vector'])
