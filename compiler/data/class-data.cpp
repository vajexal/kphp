...
void ClassData::set_name_and_src_name(const std::string &name) {
  ...
  this->is_lambda = vk::string_view{name}.starts_with("Lambda$") || vk::string_view{name}.starts_with("ITyped$");
}
